...
public class CadastroDAO {
    private final ConexaoSQLite conexaoSQLite;
       public CadastroDAO(ConexaoSQLite conexaoSQLite)  {this.conexaoSQLite = conexaoSQLite;}

       public Long inserirCadastroDAO(Cadastro sCadastro) {
        ...
        public List<Cadastro> ListaCadastroDAO() {
            ...
            try {
                ...
                Log.d("ERRO LISTA CADASTRO", "ERRO AO RETORNAR CADASTRO");
            }
                return null;
            }
            public void excluirCadastroDAO(long IdCadastro, SQLiteDatabase db) {
                SQLiteDatabase dbs = null;
                try {
                    db = this.conexaoSQLite.getWritableDatabase();
                    db.delete("cadastro", "id =?", new String[]{String.valueOf(IdCadastro)});
                } catch (Exception e) {
                    Log.d("ERRO LISTA CADASTROS", "ERRO AO RETORNAR CADASTROS");
                }
            }
